...
var require_events = __commonJS({
  "../shared/dist/events.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.EVENT_TYPES = void 0;
    exports.validateRawEvent = validateRawEvent;
    exports.EVENT_TYPES = [
      "speech_started",
      "speech_ended",
      "turn_change",
    ...
    function validateRawEvent(event) {
      ...
      if (event.event_type && !exports.EVENT_TYPES.includes(event.event_type)) {
...
var require_constants = __commonJS({
  "../shared/dist/constants.js"(exports) {
    ...
    exports.LATENCY_TARGETS = {
      EVENT_PROMPT_MAX_MS: 3e3,
      // NFR-001
      EVENT_PROMPT_MEDIAN_MS: 2e3,
      // NFR-002
      REPORT_GENERATION_MAX_MS: 12e4
      // NFR-003
    };
  }
});
...
var require_api_types = __commonJS({
  "../shared/dist/api-types.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});
...
var state = {
  ...
  batchInterval: null,
  captureMode: import_shared.DEFAULT_CAPTURE_MODE,
...
function resolveCaptureMode(value, fallback = import_shared.DEFAULT_CAPTURE_MODE) {
...
async function handleStopCoaching() {
  try {
    ...
    if (state.meetingSessionId) {
      ...
      state.eventBuffer = [];
      state.captureMode = import_shared.DEFAULT_CAPTURE_MODE;
      state.promptsMutedByUser = false;
      state.coachingPausedByUser = false;
      state.batchInterval = null;
      state.pollingInterval = null;
